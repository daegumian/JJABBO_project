                    ...
                    if(time >= 1400 && time <= 2100){
                        if(arr[i].category == 'POP'){
                            ...
                            if(arr[i].fcstValue == 1){
                                weather_icon.src = "img2/bsun.png";
                                weather_text.innerHTML = "맑음";
                                hn.nextElementSibling.firstElementChild.src = 'img2/ssunny.png';
                            } else if(arr[i].fcstValue == 3){
                                weather_icon.src = "img2/bcloud.png";
                                weather_text.innerHTML = "구름많음";
                                hn.nextElementSibling.firstElementChild.src = 'img2/scloud.png'
                            } else if(arr[i].fcstValue == 4){
                                weather_icon.src = "img2/bnotsun.png";
                                weather_text.innerHTML = "흐림";
                                hn.nextElementSibling.firstElementChild.src = 'img2/swindy.png'
                            }
